                                            ...
                                            ?>
                                                <form method="post" action="">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="contactnumber" name="contactnumber" aria-describedby="emailHelp" required="true" value="<?php echo $row['MobileNumber']; ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" required="true" value="<?php echo $row['Email']; ?>">
