...
<hr />
                                <div class="data-tables">
                                   <table class="table text-center">
                                        ...
                                        <?php
$ret=mysqli_query($con,"select * from tblticforeigner where date(PostingDate) between '$fdate' and '$tdate'");
$cnt=1;
...
?>
          ...
          <tr data-expanded="true">
            <td><?php echo $cnt;?></td>
                  ...
                  <td><a href="index.php?act=manage-foreigners-ticket&viewid=<?php echo $row['ID'];?>" class="btn btn-primary btn-xs">View</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
