                                            ...
                                            ?>
                                                    <tbody>
                                                        <tr data-expanded="true">
                                                            ...
                                                            <td><a href="index.php?act=view-normal-ticket&viewid=<?php echo $row['ID']; ?>" class="btn btn-primary btn-xs">View</a>
                                                                <a href="index.php?act=manage-normal-ticket&id=<?php echo $row['ID'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-xs">Delete</a>
                                                        </tr>
                                                    <?php
                                                    $cnt = $cnt + 1;
                                                }
