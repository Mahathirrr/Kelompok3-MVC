...
if (strlen($_SESSION['zmsaid'] == 0)) {
    ...
    if ($_GET['del']) {
        ...
        echo "<script>window.location.href='index.php?act=manage-foreigners-ticket'</script>";
    }
                                            ...
                                            ?>
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><a href="index.php?act=view-foreigner-ticket&viewid=<?php echo $row['ID']; ?>" class="btn btn-primary btn-xs">View</a>
                                                            <a href="index.php?act=manage-foreigners-ticket&id=<?php echo $row['ID'] ?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-danger btn-xs">Delete</a>
                                                    </tr>
                                                <?php
                                                $cnt = $cnt + 1;
                                            } ?>
