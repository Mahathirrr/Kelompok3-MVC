...
?>
  ...
  <head>
    ...
    <title>Search Foreign Ticket - Zoo Management System</title>
                ...
                <div class="card-body">
                  <form id="basic-form" method="post">
                    <div class="form-group">
                      ...
                      <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Ticket ID or Visitor Name">
                    </div>
