...
?>
    ...
    <head>
        ...
        <title>Railway Pass Management System | Manage Category</title>
        ...
        <!-- Page-Level CSS -->
        <link href="/rail/assets/admin/assets/plugins/dataTables/dataTables.bootstrap.css" rel="stylesheet" />
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $row) {               ?>
                                                    <tr>
                                                        ...
                                                        <td><a href="index.php?act=edit_category_detail&editid=<?php echo htmlentities($row->ID); ?>" class="btn btn-info btn-sm">Edit</a>
                                                            <a href="index.php?act=manage_category&delid=<?php echo ($row->ID); ?>" onclick="return confirm('Do you really want to Delete ?');" class="btn btn-danger btn-sm">Remove</i></a>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
