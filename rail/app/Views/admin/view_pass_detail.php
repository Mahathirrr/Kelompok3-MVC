...
?>
  ...
  <head>
    ...
    <title>Railway Pass Management System | View Pass Details</title>
                      ...
                      foreach ($results as $row) {               ?>
                        <table border="1" class="table table-bordered">
                          ...
                          <tr>
                            ...
                            <th scope>Photo</th>
                            <td><img src="admin/images/<?php echo ($row->ProfileImage); ?>" width="50" height="50"></td>

                          </tr>
                          <tr>
                            <th scope>Full Name</th>
                            <td><?php echo ($row->FullName); ?></td>
                            <th scope>Class of Pass Eligible</th>
                            <td><?php echo ($row->TrainClass); ?></td>
                          </tr>
                          <tr>
