                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $row) {               ?>
                                                    ...
                                                    <div class="form-group"> <label for="exampleInputEmail1">Photo</label> <img src="images/<?php echo $row->ProfileImage; ?>" width="50" height="50" value="<?php echo $row->ProfileImage; ?>">
                                                        <a href="index.php?act=changeimage&viewid=<?php echo $row->ID; ?>"> &nbsp; Edit Image</a>
                                                    </div>
                                                    ...
                                                    <div class="form-group"> <label for="exampleInputEmail1">Class of Pass Eligible</label><select type="text" name="trainclass" value="" class="form-control" required='true'>
                                                            <option value="<?php echo $row->TrainClass; ?>"><?php echo $row->TrainClass; ?></option>
